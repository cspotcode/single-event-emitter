 ...
 */
export class EventEmitter<E extends EmitSpec = [-1]> {
  /**
   * Return the listeners registered.
   */
  listeners(): Array<ListenerFn<E>>;
   ...
   */
  readonly emit: EmitMethod<E>;

  /**
   * Add a listener.
   */
  on(fn: ListenerFn<E>, context?: any): this;
  addListener(fn: ListenerFn<E>, context?: any): this;

  /**
   * Add a one-time listener.
   */
  once(fn: ListenerFn<E>, context?: any): this;

  /**
   * Remove the listeners.
   */
  removeListener(fn?: ListenerFn<E>, context?: any, once?: boolean): this;
  off(fn?: ListenerFn<E>, context?: any, once?: boolean): this;
...
/**
 * The observable half of an event emitter.
 * Omits emit APIs so you can only bind to events, not generate them.
 */
export type Observable<E extends EmitSpec = [-1]> = {
  [K in 'removeListener' | 'off' | 'once' | 'on' | 'addListener']: EventEmitter<EmitSpec>[K];
}
